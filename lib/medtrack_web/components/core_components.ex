defmodule MedtrackWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MedtrackWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MedtrackWeb.Gettext, "errors", msg, opts)
    end
  end
